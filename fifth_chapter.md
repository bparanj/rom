...
The last form of defining a class methods will lead to difficulty in maintenance. Because you cannot determine whether it is an instance method or a class method easily. This happens when the class methods are way down below its class << self declaration, 
